...
# Create and attach the custom observer
frequency = 1
# observer = CustomObserver(frequency=frequency,algorithm="localsearch")
observer = CuBasicObserver(1)
...
# if not os.path.exists("LocalSearch" + "/" + file_name + "/" + str(num_experiment)):
#         os.makedirs("LocalSearch" + "/" + file_name + "/" + str(num_experiment))
# observer.export_to_csv("LocalSearch" + "/" + file_name + "/" + str(num_experiment)+"/"+"evolution_data.csv")
# observer.export_plot("LocalSearch" + "/" + file_name + "/" + str(num_experiment)+"/"+"fitness_evolution.png")

# if not os.path.exists("LocalSearch" + "/" + file_name + "_three" + "/" + str(num_experiment)):
#         os.makedirs("LocalSearch" + "/" + file_name + "_three" + "/" + str(num_experiment))
# observer.export_to_csv("LocalSearch" + "/" + file_name + "_three" +  "/" + str(num_experiment)+"/"+"evolution_data.csv")
# observer.export_plot("LocalSearch" + "/" + file_name + "_three" + "/" + str(num_experiment)+"/"+"fitness_evolution.png")

if not os.path.exists("RandomSearch" + "/" + file_name + "/" + str(num_experiment)):
        os.makedirs("RandomSearch" + "/" + file_name  + "/" + str(num_experiment))
observer.export_to_csv("RandomSearch" + "/" + file_name  +  "/" + str(num_experiment)+"/"+"evolution_data.csv")
observer.export_plot("RandomSearch" + "/" + file_name  + "/" + str(num_experiment)+"/"+"fitness_evolution.png")
