...
if __name__ == '__main__':
    ...
    if not os.path.exists("noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment)):
        os.makedirs("noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment))
    log_df.to_csv("noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment)+"/log.csv")

    if not os.path.exists("noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment)):
        os.makedirs("noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment))
    result_df.to_csv("noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment)+"/itr_results.csv")

    if not os.path.exists("noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment)):
        os.makedirs("noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment))
    solution_df.to_csv("noise/qaoa_"+str(reps)+"/" + file_name+ "_two" + "/size_" + str(problem_size) + "/" + str(num_experiment)+"/solution.csv")
