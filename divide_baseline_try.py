...
if __name__ == '__main__':
    ...
    if not os.path.exists("divide_baseline_try/"+ file_name + "/" + str(num_experiment)):
        os.makedirs("divide_baseline_try/"+ file_name + "/" + str(num_experiment))
    log_df.to_csv("divide_baseline_try/"+ file_name + "/" + str(num_experiment)+"/log.csv")

    if not os.path.exists("divide_baseline_try/"+ file_name + "/" + str(num_experiment)):
        os.makedirs("divide_baseline_try/"+ file_name + "/" + str(num_experiment))
    solution_df.to_csv("divide_baseline_try/"+ file_name + "/" + str(num_experiment)+"/solution.csv")
